 ...
 * @author luis.perez
 */
@Named("wpnClaveEspecialModificarValidacionPositivaController")
@SessionScoped
public class ClaveEspecialModificarValidacionPositivaController extends BDSUtil implements Serializable {
    ...
    private static final Logger logger = Logger.getLogger(ClaveEspecialModificarValidacionPositivaController.class.getName());
    ...
    public void validarIdentificacion(FacesContext context, UIComponent component, Object value) throws ValidatorException {
        ...
        if (!numeroIdentificacionSession.equals(numeroIdentificacionIngresado)) {
            logger.error("********** TRAZA PARA NUMERO DE IDENTIFICACION SESSION RE **********| Numero de Identificacion ingresado: |" + numeroIdentificacionIngresado + "| Numero de Identificacion session: |" + numeroIdentificacionSession + "| CodCliente Abanks |" + sesionController.getUsuario().getCodUsuario() + "|");
            ...
            if (!numeroIdentificacionBD.equals(numeroIdentificacionIngresado)) {
                logger.error("********** TRAZA PARA NUMERO DE IDENTIFICACION BD RE **********| Numero de Identificacion ingresado: |" + numeroIdentificacionIngresado + "| Numero de Identificacion bd: |" + numeroIdentificacionBD + "| CodCliente Abanks |" + sesionController.getUsuario().getCodUsuario() + "|");
    ...
    public void doContinuar() {
        if (validarPreguntasDesafio()) {
            ...
            redirectFacesContext("/sec/seguridad/clave_especial_mo_ingreso_datos.xhtml");
        } else {
