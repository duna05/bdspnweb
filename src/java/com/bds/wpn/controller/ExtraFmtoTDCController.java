 ...
 * @author cesar.mujica
 */
@Named("wpnExtraFmtoTDCController")
@SessionScoped
public class ExtraFmtoTDCController extends BDSUtil implements Serializable {
    ...
    private String[] cuotasPago = null;
    private String cuotaPagoSeleccionada = "";
    ...
    public String getCuotaPagoSeleccionada() {
        return cuotaPagoSeleccionada;
    }

    public void setCuotaPagoSeleccionada(String cuotaPagoSeleccionada) {
        this.cuotaPagoSeleccionada = cuotaPagoSeleccionada;
    }
    ...
    public void limpiar() {
        if (sesionController.isReiniciarForm()) {
            ...
            cuotaPagoSeleccionada = "";
            monto = "";
            codTDC = "";
            nroReferencia = "";
            consultarCuentasPropias();
            consultarTDCPropias();
            String cuotas = parametrosController.getNombreParametro("pnw.extraFmto.lista.cuotasPago", sesionController.getIdCanal());
            if (cuotas != null && !cuotas.trim().isEmpty()) {
                cuotasPago = cuotas.split("-");
            } else {
                ...
                FacesContext.getCurrentInstance().addMessage("formExtraFmto:selectCuota", fMsg);
            }
    ...
    public void consultarCuentasPropias() {
        ...
        if (!datosCliente.getRespuestaDTO().getCodigo().equals(CODIGO_RESPUESTA_EXITOSO)) {
            ...
            FacesMessage fMsg = new FacesMessage(FacesMessage.SEVERITY_ERROR, textosFacade.findByCodigo("pnw.global.error.generico", sesionController.getNombreCanal()).getMensajeTecnico(),
                    textosFacade.findByCodigo("pnw.global.error.generico", sesionController.getNombreCanal()).getMensajeUsuario());
            FacesContext.getCurrentInstance().addMessage("formExtraFmto:selectCtaDestino", fMsg);
        } else {
    ...
    public void consultarTDCPropias() {
        ...
        if (!datosCliente.getRespuestaDTO().getCodigo().equals(CODIGO_RESPUESTA_EXITOSO)) {
            ...
            FacesMessage fMsg = new FacesMessage(FacesMessage.SEVERITY_ERROR, textosFacade.findByCodigo("pnw.global.error.generico", sesionController.getNombreCanal()).getMensajeTecnico(),
                    textosFacade.findByCodigo("pnw.global.error.generico", sesionController.getNombreCanal()).getMensajeUsuario());
            FacesContext.getCurrentInstance().addMessage("formExtraFmto:txtCtaAbonar", fMsg);
        } else {
    ...
    public void consultarDetalleTDC() {
        if (tdcSeleccionada != null && !tdcSeleccionada.equalsIgnoreCase("-1")) {
            ...
            if (validacionesSeguridad) {
                ...
                FacesMessage fMsg = new FacesMessage(FacesMessage.SEVERITY_ERROR, textosFacade.findByCodigo("pnw.global.error.generico", sesionController.getNombreCanal()).getMensajeTecnico(),
                        textosFacade.findByCodigo("pnw.global.error.generico", sesionController.getNombreCanal()).getMensajeUsuario());
                FacesContext.getCurrentInstance().addMessage("formExtraFmto:divMsjAvcEfect", fMsg);
            }
        } else {
            this.limpiar();
        }
     ...
     */
    public void regresarExtraFmtoPaso1() {
     ...
     */
    public void regresarExtraFmtoPaso2() {
        sesionController.setValidadorFlujo(2);
        this.redirectFacesContext(parametrosController.getNombreParametro("pnw.extraFmtoTDC.url.paso2", sesionController.getIdCanal()));
    }
     ...
     */
    public void validarFlujoExtraFmto2() {
        if (!FacesContext.getCurrentInstance().isPostback()) {
            if (sesionController.getValidadorFlujo() != 2 || !sesionController.getIdTransaccion().equals(BDSUtil.ID_TRANS_EXTRA_FMTO)) {
                sesionController.setValidadorFlujo(1);
                this.regresarExtraFmtoPaso1();
            }
        }
    }
     ...
     * redireeciona al paso 1
     */
    public void validarFlujoExtraFmto3() {
        if (!FacesContext.getCurrentInstance().isPostback()) {
            if (sesionController.getValidadorFlujo() != 3 || !sesionController.getIdTransaccion().equals(BDSUtil.ID_TRANS_EXTRA_FMTO)) {
                sesionController.setValidadorFlujo(1);
                this.regresarExtraFmtoPaso1();
            }
        }
     ...
     * redireeciona al paso 1
     */
    public void validarFlujoExtraFmto4() {
        if (!FacesContext.getCurrentInstance().isPostback()) {
            if (sesionController.getValidadorFlujo() != 4 || !sesionController.getIdTransaccion().equals(BDSUtil.ID_TRANS_EXTRA_FMTO)) {
                sesionController.setValidadorFlujo(1);
                this.regresarExtraFmtoPaso1();
            }
        }
     ...
     * metodo utilitario que redirecciona al OTP
     */
    public void regresarPagExtraFmtoPaso1() {
        this.redirectFacesContext(parametrosController.getNombreParametro("pnw.otp.url.validacionOtp", sesionController.getIdCanal()));
    }

    /**
     * metodo para redirigir a paso 2 de pago de ext fmto
     */
    public void regresarPagExtraFmtoPaso2() {
        sesionController.setValidadorFlujo(2);
        this.redirectFacesContext(parametrosController.getNombreParametro("pnw.pagExtraFmtoTDC.url.paso2", sesionController.getIdCanal()));
    }
     ...
     * redireeciona al paso 1
     */
    public void validarFlujoPagExtraFmto2() {
        if (!FacesContext.getCurrentInstance().isPostback()) {
            if (sesionController.getValidadorFlujo() != 2 || !sesionController.getIdTransaccion().equals(BDSUtil.ID_TRANS_PAG_EXTRA_FMTO)) {
                sesionController.setValidadorFlujo(1);
                this.regresarExtraFmtoPaso1();
            }
        }
     ...
     * redireeciona al paso 1
     */
    public void validarFlujoPagExtraFmto3() {
        if (!FacesContext.getCurrentInstance().isPostback()) {
            if (sesionController.getValidadorFlujo() != 3 || !sesionController.getIdTransaccion().equals(BDSUtil.ID_TRANS_PAG_EXTRA_FMTO)) {
                sesionController.setValidadorFlujo(1);
                this.regresarExtraFmtoPaso1();
            }
        }
     ...
     * redireeciona al paso 1
     */
    public void validarFlujoPagExtraFmto4() {
        if (!FacesContext.getCurrentInstance().isPostback()) {
            if (sesionController.getValidadorFlujo() != 4 || !sesionController.getIdTransaccion().equals(BDSUtil.ID_TRANS_PAG_EXTRA_FMTO)) {
                sesionController.setValidadorFlujo(1);
                this.regresarExtraFmtoPaso1();
            }
        }
     ...
     */
    public void extraFmtoPaso3() {
        int cantErrores = 0;
        if (tdcSeleccionada == null || tdcSeleccionada.trim().equalsIgnoreCase("-1")) {
            cantErrores++;
            FacesContext context = FacesContext.getCurrentInstance();
            context.getExternalContext().getFlash().setKeepMessages(true);
            FacesContext.getCurrentInstance().addMessage("formExtraFmto:selectTDC", new FacesMessage(FacesMessage.SEVERITY_ERROR, "", textosController.getNombreTexto("pnw.errores.texto.seleccioneTDC", sesionController.getNombreCanal())));
        } else {
            ...
            if (mtoAvc.compareTo(datosTDCSeleccionada.getMontoDisponible()) == 1) {
                ...
                FacesContext context = FacesContext.getCurrentInstance();
                context.getExternalContext().getFlash().setKeepMessages(true);
                FacesContext.getCurrentInstance().addMessage("formExtraFmto:txtMonto", new FacesMessage(FacesMessage.SEVERITY_ERROR, "", textosController.getNombreTexto("pnw.global.texto.saldoInsuficiente", sesionController.getNombreCanal())));
            }
            if (codTDC == null || codTDC.isEmpty() || codTDC.trim().length() != 3) {
                cantErrores++;
                FacesContext context = FacesContext.getCurrentInstance();
                context.getExternalContext().getFlash().setKeepMessages(true);
                FacesContext.getCurrentInstance().addMessage("formExtraFmto:txtCodTDC", new FacesMessage(FacesMessage.SEVERITY_ERROR, "", textosController.getNombreTexto("pnw.global.texto.codTDCInv", sesionController.getNombreCanal())));
            }
        }
        ...
        if (cantErrores > 0) {
            ...
            this.redirectFacesContext(parametrosController.getNombreParametro("pnw.extraFmtoTDC.url.paso3", sesionController.getIdCanal()));
        }
    }

    public void extraFmtoPaso4() {
        ...
        //INVOCAR AL WS DE EXTRA FINANCIAMIENTO
        if (utilP2P.getRespuestaDTO() != null && utilP2P.getRespuestaDTO().getCodigo() != null && utilP2P.getRespuestaDTO().getCodigo().equalsIgnoreCase(CODIGO_RESPUESTA_EXITOSO)) {
            if (utilP2P.getRespuestaDTO().getCodigoSP().equalsIgnoreCase(CODIGO_RESPUESTA_EXITOSO)) {
                ...
                sesionController.registroBitacora(sesionController.getUsuario().getId().toString(), sesionController.getIdTransaccion(), formatoAsteriscosWeb(this.datosTDCSeleccionada.getNumeroTarjeta()),
                        formatoAsteriscosWeb(this.datosCtaSeleccionada.getNumeroCuenta()), "Extra Financiamiento de TDC", this.monto, this.nroReferencia, "", "", "", "", "");
                String textoSMS = textosController.getNombreTexto("pnw.sms.cuerpo.extraFmtoTDC", sesionController.getNombreCanal());
                String motivoSMS = textosController.getNombreTexto("pnw.sms.motivo.extraFmtoTDC", sesionController.getNombreCanal());
                ...
                this.notificarExtraFmtoEmail();
                this.redirectFacesContext(parametrosController.getNombreParametro("pnw.extraFmtoTDC.url.paso4", sesionController.getIdCanal()));

            } else {
                FacesContext context = FacesContext.getCurrentInstance();
                context.getExternalContext().getFlash().setKeepMessages(true);
                FacesContext.getCurrentInstance().addMessage("formExtraFmto:divMsjSinAfiliaciones", new FacesMessage(FacesMessage.SEVERITY_WARN, "", utilP2P.getRespuestaDTO().getDescripcionSP()));
                sesionController.setValidadorFlujo(3);
                this.redirectFacesContext(parametrosController.getNombreParametro("pnw.extraFmtoTDC.url.paso3", sesionController.getIdCanal()));
            }
        } else {
            FacesContext context = FacesContext.getCurrentInstance();
            context.getExternalContext().getFlash().setKeepMessages(true);
            FacesContext.getCurrentInstance().addMessage("formExtraFmto:divMsjSinAfiliaciones", new FacesMessage(FacesMessage.SEVERITY_ERROR, "", textosController.getNombreTexto("pnw.global.error.generico", sesionController.getNombreCanal())));
            sesionController.setValidadorFlujo(3);
            this.redirectFacesContext(parametrosController.getNombreParametro("pnw.extraFmtoTDC.url.paso3", sesionController.getIdCanal()));
        }
    }
     ...
     * del proceso de Extra Financiamiento
     */
    public void notificarExtraFmtoEmail() {
        ...
        asunto = "Extra Finaciamiento de TDC, DELSUR";
        ...
        textoE.append(NUEVALINEAEMAIL);
        textoE.append("Le informamos que su solicitud de Extra Financiamiento de TDC se realizó satisfactoriamente según el siguiente detalle:");
        textoE.append(NUEVALINEAEMAIL);
        textoE.append(NUEVALINEAEMAIL);

        texto.append("Recibo del Extra Financiamiento de TDC ");
        ...
        texto.append(NUEVALINEAEMAIL);
        texto.append("Monto del Extra Financiamiento de TDC: ");
        texto.append(monto);
        texto.append(" Bs.");
        texto.append(NUEVALINEAEMAIL);
        ...
        texto.append(NUEVALINEAEMAIL);
        texto.append(NUEVALINEAEMAIL);
        texto.append("Este correo electrónico se genera automáticamente cada vez que se realiza un Extra Financiamiento de TDC. Por su seguridad no responda al mismo y en caso que desconozca esta transacción, comuníquese inmediatamente con nosotros a través de los teléfonos 0212-208.73.44 / 0212-208.74.45");
        //texto.append(NUEVALINEAEMAIL);
    ...
    /**
     * metodo encargado de armar el reportes de Extra Financiamiento en PDF
     *
     * @throws java.io.IOException
     * @throws com.lowagie.text.DocumentException
     */
    public void detalleExtraFmtoPDF() throws IOException, DocumentException {

        try {

            String nombreDocumento;

            nombreDocumento = "ExtraFinanciamiento.pdf";
            ...
            this.cuerpoExtraFmtoPDF(document);
     ...
     */
    public void cuerpoExtraFmtoPDF(Document pdf) throws BadElementException, DocumentException {
        try {
            ...
            //    table.getDefaultCell().setBorder(0);
            PdfPCell cell = new PdfPCell((new Phrase(textosController.getNombreTexto("pnw.extraFmtoTDC.descargaPdf.titulo", sesionController.getIdCanal()), fontTituloBold)));
            ...
            table.getDefaultCell().setBackgroundColor(new Color(230, 230, 230));
            table.addCell(new Phrase(textosController.getNombreTexto("pnw.extraFmtoTDC.descargaPdf.tdc", sesionController.getIdCanal()), fontBold));
            ...
            table.getDefaultCell().setBackgroundColor(new Color(230, 230, 230));
            table.addCell(new Phrase(textosController.getNombreTexto("pnw.extraFmtoTDC.descargaPdf.ctaDestino", sesionController.getIdCanal()), fontBold));
            table.getDefaultCell().setBackgroundColor(new Color(255, 255, 255));
            table.addCell(new Phrase(formatoAsteriscosWeb(this.datosCtaSeleccionada.getNumeroCuenta()), font));

            table.getDefaultCell().setBackgroundColor(new Color(230, 230, 230));
            table.addCell(new Phrase(textosController.getNombreTexto("pnw.extraFmtoTDC.descargaPdf.monto", sesionController.getIdCanal()), fontBold));
            table.getDefaultCell().setBackgroundColor(new Color(255, 255, 255));
            table.addCell(new Phrase(this.monto, font));

            table.getDefaultCell().setBackgroundColor(new Color(230, 230, 230));
            table.addCell(new Phrase(textosController.getNombreTexto("pnw.extraFmtoTDC.descargaPdf.cuotas", sesionController.getIdCanal()), fontBold));
            table.getDefaultCell().setBackgroundColor(new Color(255, 255, 255));
            table.addCell(new Phrase(this.cuotaPagoSeleccionada, font));

            table.getDefaultCell().setBackgroundColor(new Color(230, 230, 230));
            table.addCell(new Phrase(textosController.getNombreTexto("pnw.extraFmtoTDC.descargaPdf.nroRef", sesionController.getIdCanal()), fontBold));
            table.getDefaultCell().setBackgroundColor(new Color(255, 255, 255));
